...
### id
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Sounds::id(integer $soundId)
...
#### Arguments
* $soundId **integer** - &lt;p&gt;Sound id.&lt;/p&gt;



### name

    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Sounds::name(string $name)
...
#### Arguments
* $name **string** - &lt;p&gt;Sound name.&lt;/p&gt;



### description

    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Sounds::description(string $description)
...
#### Arguments
* $description **string** - &lt;p&gt;Sound description.&lt;/p&gt;



### saveTo

    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Sounds::saveTo(string $filename)
...
### sound
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Sounds::sound(string $filename)
...
#### Arguments
* $filename **string** - &lt;p&gt;The mp3 file.&lt;/p&gt;
