PortaText\Command\Api\EmailVerify
===============
...
### withNonce
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\EmailVerify::withNonce(string $nonce)
...
#### Arguments
* $nonce **string** - &lt;p&gt;The nonce to verify the email.&lt;/p&gt;
