...
### to
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Calls::to(string $target)
...
### from
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Calls::from(string $number)
...
### outboundTrunk
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Calls::outboundTrunk(integer $trunkId)
...
### dialTimeout
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Calls::dialTimeout(integer $dialTimeout)
...
### flow
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Calls::flow(array $flow)
