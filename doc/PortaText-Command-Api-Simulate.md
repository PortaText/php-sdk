PortaText\Command\Api\Simulate
===============
...
### country
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Simulate::country(string $country)
...
#### Arguments
* $country **string** - &lt;p&gt;2-letter country ISO code.&lt;/p&gt;



### useTemplate

    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Simulate::useTemplate(integer $templateId, array $variables)
...
### text
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Simulate::text(string $text)
