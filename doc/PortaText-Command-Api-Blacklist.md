PortaText\Command\Api\Blacklist
===============
...
### number
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Blacklist::number(string $number)
...
#### Arguments
* $number **string** - &lt;p&gt;The number to blacklist.&lt;/p&gt;



### csv

    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Blacklist::csv(string $filename)
