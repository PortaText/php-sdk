...
### name
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Trunks::name(string $name)
...
### id
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Trunks::id(integer $trunkId)
