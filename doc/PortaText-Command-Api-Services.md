PortaText\Command\Api\Services
===============
...
### id
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Services::id(integer $serviceId)
...
#### Arguments
* $serviceId **integer** - &lt;p&gt;The service id.&lt;/p&gt;



### saveTo

    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Services::saveTo(string $filename)
...
### page
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Services::page(integer $page)
