PortaText\Command\Api\Operators
===============
...
### page
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Operators::page(integer $page)
...
### sortBy
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\Operators::sortBy(string $sortBy, string $order)
...
#### Arguments
* $sortBy **string** - &lt;p&gt;&#039;country&#039; or &#039;mcc&#039;.&lt;/p&gt;
