PortaText\Command\Api\NumberVerify
===============
...
### forNumber
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\NumberVerify::forNumber(string $number)
...
#### Arguments
* $number **string** - &lt;p&gt;The number where to send the verification code to.&lt;/p&gt;
...
### from
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\NumberVerify::from(string $number)
...
### useTemplate
    ...
    \PortaText\Command\Api\PortaText\Command\ICommand PortaText\Command\Api\NumberVerify::useTemplate(integer $templateId, array $variables)
